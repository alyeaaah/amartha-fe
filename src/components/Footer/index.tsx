      ...
      <LayoutWrapper className="grid grid-cols-12 gap-6 w-full ">
        <div className="col-span-12 sm:col-span-6 lg:col-span-4">
          ...
          <div className='flex flex-col items-start justify-start my-2'>
            ...
            <div className='flex flex-row items-center justify-start'>
              <Button
                className="text-black my-3 hover:!text-[#000] hover:!bg-[#471F81] border-none"
        ...
        <div className="col-span-12 sm:col-span-6 lg:col-span-4 relative pt-4">
          ...
          <div className='w-4 h-0.5 bg-[#fff]'></div>
        ...
        <div className="col-span-12 sm:col-span-6 lg:col-span-4 pt-4">
          ...
          <div className="flex flex-col items-start justify-start !text-white font-medium pt-3">
            <ul>
              <li className='py-1 '>
                <Link href="#" className="flex flex-row !text-white hover:!text-[#471F81] items-center"><YoutubeOutlined name='Youtube' className='w-5' />&nbsp;Youtube</Link>
              </li>
              <li className='py-1 '>
                <Link href="#" className="flex flex-row !text-white hover:!text-[#471F81] items-center"><TikTokOutlined className='w-5' />&nbsp;Tiktok</Link>
              </li>
              <li className='py-1 '>
                <Link href="#" className="flex flex-row !text-white hover:!text-[#471F81] items-center"><TwitterOutlined className='w-5' />&nbsp;Twitter / X</Link>
              </li>
            </ul>
          </div>
        </div>
