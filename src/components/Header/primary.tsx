...
export const AdminHeader = ({ className, innerClassName }: LandingPageProps) => {
  ...
  return (
    <Header className={`bg-[#2A5E90] flex flex-col items-center h-24 ${className}`}>
      <LayoutWrapper className='h-full'>
        <div className={`border-white rounded-xl flex justify-between items-center h-full w-full px-4 ${innerClassName}`}>
          <Link to={paths.landingPage}>
            <Title level={3} className="!text-[#fff] !mb-0 flex flex-row">
          ...
          <div className="w-full ">
            <Menu
              ...
              className='bg-transparent text-[#fff] text-sm flex justify-end items-center custom-menu border-none'
              mode="horizontal"
              defaultSelectedKeys={['/']}
