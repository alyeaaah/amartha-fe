    ...
    <>
      <div
        className={clsx([
          ...
          "after:hidden after:xl:block after:content-[''] after:w-[57%] after:-mt-[20%] after:-mb-[13%] after:-ml-[13%] after:absolute after:inset-y-0 before:left-0 after:transform after:rotate-[-4.5deg] after:bg-[linear-gradient(to_right_bottom,#38144E,#92599D)] after:rounded-[100%] after:dark:bg-darkmode-700",
        ])}
      >
          ...
          <div className="block grid-cols-2 gap-4 xl:grid">
            ...
            <div className="flex-col hidden min-h-screen xl:flex">
              ...
              <div className="my-auto">
                ...
                <div className="mt-10 text-4xl font-nunito leading-tight text-white -intro-x">
